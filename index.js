    ...
    ZimBotInc.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                let link = `https://youtu.be/iik25wqIuFo`
let buttons = [
...
caption: he,
footer: `©SquidWard MD 2022`,
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
title: `Gosah Sok Ganteng Lu Bukan NABI ADAM & NABI MUSA`,
body: `Jangan Lupa Nonton YouTube Biru`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
mediaUrl: link,
...
headerType: 4,
contextInfo:{externalAdReply:{
title: `Gosah Balik Ngen `,
body: `Donasi Kawan https://saweria.co/Gerall`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
mediaUrl: link,
...
ZimBotInc.sendMessage(anu.id, buttonMessage, {quoted:fgclink})
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await ZimBotInc.getName(i + '@s.whatsapp.net')}\nFN:${await ZimBotInc.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:OWNER\nitem2.EMAIL;type=INTERNET:SquidWard-BOT@bukangmail.SW\nitem2.X-ABLabel:Email\nitem3.URL:https://xnxx.com\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;ISEKAI MENJADI NPC;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
